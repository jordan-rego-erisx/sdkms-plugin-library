...
describe('bitcoinjs-lib (transactions)', function () {
  it('can create a 1-to-1 Transaction', async function () {
  ...
  it('can create a 2-to-2 Transaction', async function () {
    ...
    await txb.sign(1, bob) // Bob signs his input, which was the second input (1th)
    await txb.sign(0, alice) // Alice signs her input, which was the first input (0th)
